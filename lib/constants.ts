...
export const PRODUCTS = [
  {
    ...
    description: "Inbound & outbound calls powered by AI",
    icon: "phone",
  },
  {
    title: "RAG Chatbots",
    description: "Intelligent AI chatbots with knowledge retrieval",
    icon: "message-circle",
  },
  {
    title: "AI-Driven CRMs",
    description: "Value-driven automation for customer relationships",
    icon: "database",
  },
]
