...
export function ContactClean() {
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden bg-white dark:bg-neutral-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {/* Content */}
          <FadeIn delay={0.3}>
            <div className="bg-gray-50 dark:bg-neutral-900 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-3xl p-8 md:p-12 shadow-lg">
              {activeTab === "form" ? (
                <div className="max-w-2xl mx-auto">
                  <form className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-white dark:bg-neutral-950 border-gray-300 dark:border-gray-600 text-black dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
                        />
                      </div>
                      <div>
                        <label
                    ...
                    <div>
                      ...
                      <select
                        id="interest"
                        className="w-full px-4 py-3 rounded-lg bg-white dark:bg-neutral-950 border border-gray-300 dark:border-gray-600 text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-white"
                      >
                    ...
                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                      <Button
                        type="submit"
                        className="w-full bg-black dark:bg-white text-white dark:text-gray-900 font-semibold py-6 text-lg hover:bg-gray-800 dark:hover:bg-gray-100"
                      >
